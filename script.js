...
const popupData={
 ...
 date:{art:'DATE & VENUE UTK POP UP.png',body:`<div class="date-venue-body"><img class="map-photo" src="gallery/venue.jpg" alt="Estusae Cafe"><div class="date-venue-date">22 November 2026</div><div class="date-venue-divider">✦</div><div class="date-venue-times"><div><span>Akad</span><b>08:00–09:00 WIB</b></div><div><span>Resepsi</span><b>10:00–13:00 WIB</b></div></div><div class="date-venue-divider">✦</div><div class="date-venue-venue"><strong>Estusae Cafe, Trawas, Mojokerto</strong><span>Sendang, Penanggungan, Kec. Trawas,<br>Kabupaten Mojokerto, Jawa Timur 61375</span></div><div class="date-venue-dress"><strong>Dress Code</strong><span>“Pakaian Ternyaman, Versi Terbaikmu”</span></div><button class="maps-image" id="mapsBtn"><img src="assets/BUKA MAPS.png" alt="Buka Maps"></button></div>`},
